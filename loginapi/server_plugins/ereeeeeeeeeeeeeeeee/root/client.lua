...
while true do
    ...
    if data == "on" then
        eln.wirelessSet("mains_turbines",1)
        if power == "off" then
    ...
    if data == "off" then
        eln.wirelessSet("mains_turbines",0)
        if power == "on" then
    ...
    if datab == "on" then
        eln.wirelessSet("mains_attach",1)
        if gens == "off" then
    ...
    if datab == "off" then
        eln.wirelessSet("mains_attach",0)
        if gens == "on" then
    ...
    if datad == "on" then
        eln.wirelessSet("mains_starter",1)
        if start == "off" then
    ...
    if datad == "off" then
        eln.wirelessSet("mains_starter",0)
        if start == "on" then
    ...
    internet.request(url.."/api?server="..server.."&mode=setTorta&value="..eln.wirelessGet("mains_tor"))
    internet.request(url.."/api?server="..server.."&mode=setSpeed&value="..eln.wirelessGet("mains_speed"))
    internet.request(url.."/api?server="..server.."&mode=setVolt&value="..eln.wirelessGet("mains_volt"))
    os.sleep(0)
end